...
namespace Microsoft.Framework.PackageManager.Restore.NuGet
{
    internal class HttpSource
    {
        ...
        // Prevent the HttpSource from making more than 5 simultaneous requests.
        // Any more than this, and HttpClient.SendAsync starts lagging and
        // throwing TaskCanceledExceptions on Mono.
